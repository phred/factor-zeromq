...
CONSTANT: ZMQ_PULL 7
CONSTANT: ZMQ_PUSH 8
CONSTANT: ZMQ_UPSTREAM ZMQ_PULL    #!   /*  Old alias, remove in 3.x               */
CONSTANT: ZMQ_DOWNSTREAM ZMQ_PUSH  #!   /*  Old alias, remove in 3.x               */
...
FUNCTION: int zmq_bind ( void *s, char *addr ) ;
#! FUNCTION: int zmq_connect ( void *s, const char *addr ) ;
FUNCTION: int zmq_connect ( void *s, char *addr ) ;
